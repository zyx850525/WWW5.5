...
export async function getFarcasterManifest() {
  ...
  return {
    ...
    miniapp: {
      ...
      subtitle: "A MiniApp that allows users to transact easily with minimum fees.", // 30 characters, no emojis or special characters, short description under app name
      description: "A MiniApp that allows users to transact easily with minimum fees.", // 170 characters, no emojis or special characters, promotional message displayed on Mini App Page
      ...
      ogDescription: "A MiniApp that allows users to transact easily with minimum fees.", // 100 characters, summarize core benefits in 1-2 lines
      screenshotUrls: [
